package io.github.oemdaro.kafka.configuring;
...
public class AppConfig {
    ...
    public static double TEMPERATURE_THRESHOLD = 30.0;
    ...
    public void initConfig(String appConfig) {
        ...
        try {
            ...
            TEMPERATURE_THRESHOLD = Double.parseDouble(getProperty("app.threshold.temperature"));
            HUMIDITY_THRESHOLD = Double.parseDouble(getProperty("app.threshold.humidity"));
